...
<span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400"> 2023 <a href="https://flowbite.com/" class="hover:underline">MIS</a>. All Rights Reserved.</span>
</div>
</footer>
    </div>
