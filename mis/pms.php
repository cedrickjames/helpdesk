...
if(isset($_POST['addPMSAction'])){
    ...
    if($results){
      ...
      $message = 'Hi '.$user.',<br> <br> MIS has completed the Preventive Maintenance for you computer. Please approve and check the details by signing in into our Helpdesk <br> Click this '.$link.' to signin. <br><br><br> This is a generated email. Please do not reply. <br><br> Helpdesk';
